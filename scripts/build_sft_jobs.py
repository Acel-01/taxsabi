...
| Layer | Conversations | Batch files | Purpose |
|---|---:|---:|---|
| A (English bulk) | {len(layer_a)} | {jobs_a} | multi-turn conversations |
| B (English coaching) | {len(layer_b)} | {jobs_b} | coaching conversations |
| C (Pidgin) | {len(layer_c)} | {jobs_c} | Pidgin conversations |
