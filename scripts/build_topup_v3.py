...
Records generated from these blueprints are verified with `scripts/verify_sft_generation.py` before entering the training pool. Pidgin records are human-reviewed.
"""
