...
Answer format:
- Calculation/single_calc: "Gross income: NGN G. Reliefs applied: ... total relief NGN R. Chargeable income: NGN C. Band breakdown: ... Total tax: NGN X." (total LAST)
- Counterfactual/single_counterfactual: "Your tax drops from NGN A to NGN B. [one-line reason] Saving: NGN S." (saving LAST)
