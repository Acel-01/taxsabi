# Single-turn English Q&A

Every blueprint is a 2-turn conversation: one user question, one assistant answer. Follow `data/sft_jobs/layer_a/README.md` tone rules. Write only the user question (per its `guidance` and `style`) and the assistant answer.
