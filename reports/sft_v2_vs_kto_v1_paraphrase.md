...
- **after:** `data/captures/kto_v1_paraphrase.jsonl` (100 records)
...
| tax exact | 15 | 17 |
| tax within NGN 1 | 15 | 17 |
| chargeable income exact | 15 | 22 |
...
| Rate | Before | After |
|---|---|---|
| tax exact | 15/40 = 38% | 17/40 = 42% |
| tax within NGN 1 | 15/40 = 38% | 17/40 = 42% |
| chargeable income | 15/40 = 38% | 22/40 = 55% |
| savings exact | 0/10 = 0% | 0/10 = 0% |

## Paraphrase consistency (same predicted tax across 5 phrasings)

- before: 3/7 groups consistent
- after: 3/8 groups consistent
...
After inconsistencies: para-calc-01: ['124500.00', '97500.00']; para-calc-03: ['549600.00', '760200.00']; para-calc-04: ['1127040.00', '1199040.00']; para-calc-05: ['157500.00', '271500.00', '277500.00']; para-calc-08: ['5918600.00', '5920600.00']

## Movement

- improved (tax wrong -> right): 4
- regressed (tax right -> wrong): 2
  - improved: para-calc-03-a, para-calc-03-c, para-calc-03-d, para-calc-05-a
  - regressed: para-calc-04-e, para-calc-05-e
...
**Expected tax:** 760200.00 | before: 558600.00 | after: 549600.00
...
**After:** Let's check. Reliefs we apply: rent relief @ 20% of the rent, capped at NGN 500,000 - total relief NGN 130,000. Chargeable income: NGN 4,220,000. Band breakdown: first NGN 800,000 at 0% = NGN 0; next NGN 2,200,000 at 15% = NGN 330,000; next NGN 1,220,000 at 18% = NGN 219,600. Total tax: NGN 549,600.
...
**Expected tax:** 1199040.00 | before: 1199040.00 | after: 1127040.00

**Before:** Gross income: NGN 8,400,000. Reliefs applied: pension NGN 500,000, NHIS NGN 72,000 - total relief NGN 572,000. Chargeable income: NGN 7,828,000. Band breakdown: first NGN 800,000 at 0% = NGN 0; next NGN 2,200,000 at 15% = NGN 330,000; next NGN 4,828,000 at 18% = NGN 869,040. Total tax: NGN 1,199,040.

**After:** Gross income: NGN 8,000,000. Reliefs applied: pension NGN 500,000, NHIS NGN 72,000 - total relief NGN 572,000. Chargeable income: NGN 7,428,000. Band breakdown: first NGN 800,000 at 0% = NGN 0; next NGN 2,200,000 at 15% = NGN 330,000; next NGN 4,428,000 at 18% = NGN 797,040. Total tax: NGN 1,127,040.
...
**After:** Your tax drops from NGN 2,220,000 to NGN 2,190,000. Doing nothing saves NGN 30,000, which is less than the amount you contribute, so the voluntary contribution is worthwhile.
...
**After:** Your tax drops from NGN 870,000 to NGN 690,000. The rent relief you claim lowers your chargeable income to NGN 4,200,000.
...
**After:** Yes, that is right. The tax drops from NGN 276,000 to NGN 189,600. The relief is the rent: 20% of the annual rent, capped at NGN 500,000.
...
**Expected tax:** 6248600.00 | before: 5853000.00 | after: 5918600.00
...
**After:** Here are the bands and rates for 2026:  - Chargeable income up to NGN 800,000: 0% - Chargeable income between NGN 800,000 and NGN 2,000,000: 15% - Chargeable income between NGN 2,000,000 and NGN 5,000,000: 18% - Chargeable income between NGN 5,000,000 and NGN 10,000,000: 21% - Chargeable income between NGN 10,000,000 and NGN 25,000,000: 23% - Chargeable income above NGN 25,000,000: 25%  The first NGN 800,000 is therefore tax-free.
...
**After:** Yes, that is correct. The Fourth Schedule table of the Nigeria Tax Act 2025 shows that the tax table applies to chargeable income up to 800,000, with the first 800,000 at 0%, the next 2,200,000 (Nigeria Civil Service salary) at 15%, and every tier above 3,000,000 at 18%. The 30% band is therefore the fourth tier, and the zero band is the first 800,000.
...
**After:** Under section 30(2)(a)(iii) of the Nigeria Tax Act 2025, eligible deductions include pension, life insurance, and mortgage interest on a home you live in. Rent relief is capped at 20% of the annual rent paid, and a VAT certificate is required for the claim.
...
**After:** No - the Fourth Schedule tax table does not apply to an individual earning the national minimum wage. Earnings at the minimum are taxed at the rate applicable to the first NGN 800,000 zeroed in, so nothing to pay.
...
**After:** Voluntary pension contributions are made through your employer into your RSA and must be made in Naira. You notify your employer in writing of your intention and the amount, and the contribution is capped at one-third of your month's salary.
...
**After:** Voluntary pension contributions are made in Naira through your employer into your RSA, and you notify your employer in writing of your intention and the amount. They can be made once a month, and you can make them only once a month.
...
**After:** VPC stands for Voluntary Pension Contribution, and it is a contribution made by an employee to his own retirement savings account. The minimum VPC is 10% of monthly emoluments, and it may be revised upwards by the employee and his employer. A VPC is mandatory in the case of an employee earning the national minimum wage, and it is also mandatory for all other employees in the case of a pension insufficiency.
...
**After:** Voluntary pension contributions are taxed at the point of withdrawal, with the option of a deferred withdrawal. If you withdraw the money before the age of 55, the tax stays on the contribution and the withdrawal is capped at one-third of the contribution. If you withdraw after 55, the tax is waived and the full amount is remitted to your pension fund.
...
**After:** No - early withdrawal of voluntary pension is exempt from income tax on the withdrawal, under section 30 of the Pension Reform Act 2014.
...
**After:** Withholding tax still applies: the employee's employer deducts it and remits to the state. A withdrawal of the pension before the age of 55 still requires the employer to remit the tax on the pension, as the pension is a taxed income.
...
**After:** Overpaid tax is refunded after an audit by the relevant tax authority, under section 55 of the Nigeria Tax Administration Act 2025. A refund is paid within 90 days of the authority's decision, and the claim for refund is made in writing within six years after the end of the year of assessment to which it relates.
...
**After:** Your annual return is filed on the LIRS e-Tax platform using the Lagos State Form LIRS-2026. Relief claims go through your employer into your refund claim form, and the claim must be written in the prescribed form.
...
**After:** No - relief claims are still made through the annual return, not separately. The claim must be written in the prescribed form (Tax Form A) and supported by evidence; the claim is allowed only if it is true and just.
