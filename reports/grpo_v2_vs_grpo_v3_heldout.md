...
- **after:** `data/captures/grpo_v3_probe_prompts_heldout.jsonl` (20 records)
...
**After:** No - the personal income tax rules apply only to individuals. A company director is taxed on their chargeable income, under the Nigeria Tax Act 2025, whether or not they receive a pension.
