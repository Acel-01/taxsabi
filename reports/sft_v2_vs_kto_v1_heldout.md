...
- **before:** `data/captures/sft_v2_heldout.jsonl` (20 records)
- **after:** `data/captures/kto_v1_heldout.jsonl` (20 records)
...
| tax exact | 4 | 5 |
| tax within NGN 1 | 4 | 5 |
| chargeable income exact | 5 | 7 |
...
| Rate | Before | After |
|---|---|---|
| tax exact | 4/10 = 40% | 5/10 = 50% |
| tax within NGN 1 | 4/10 = 40% | 5/10 = 50% |
| chargeable income | 5/10 = 50% | 7/10 = 70% |
...
**Before:** Is that 70,000 a month or 700,000 annually?
...
**Expected tax:** 0.00 | before: 51000.00 | after: None

**Before:** Gross income na NGN 1,200,000. Relief wey dey apply: rent NGN 60,000 - total relief na NGN 60,000. Chargeable income: NGN 1,140,000. Band breakdown: first NGN 800,000 at 0% = NGN 0; next NGN 340,000 at 15% = NGN 51,000. Total tax na NGN 51,000.

**After:** Is that 600,000 monthly or 600,000 annual? Relief na 0 - no rent payment at all, so nothing to reduce chargeable income.
...
**Before:** In 2026, individuals are taxed on their chargeable income using a graduated band breakdown table. Chargeable income up to 800,000 is taxed at 0%; the next 2,200,000 (800,000 to 3,000,000) is taxed at 15%; the next 9,000,000 (3,000,000 to 12,000,000) at 18%; the next 13,000,000 (12,000,000 to 25,000,000) at 21%; the next 25,000,000 (25,000,000 to 50,000,000) at 23%; and anything above 50,000,000 at 25%. The first 800,000 is therefore tax-free.

**After:** In 2026, the Nigerian tax authority applies the Fourth Schedule tax table to individuals, with the following bands: chargeable income up to NGN 800,000 is taxed at 0%; the next NGN 2,200,000 (NGN 800,000 to NGN 3,000,000) at 15%; the next NGN 9,000,000 (NGN 3,000,000 to NGN 12,000,000) at 18%; the next NGN 13,000,000 (NGN 12,000,000 to NGN 25,000,000) at 21%; the next NGN 25,000,000 (NGN 25,000,000 to NGN 50,000,000) at 23%; and anything above NGN 50,000,000 at 25%.
...
**After:** Yes - the rent relief is 20% of annual rent paid, capped at NGN 500,000, whichever is lower. The actual rent must be accurately declared and evidence may be required.

### probe-fact-03

**Prompt:** Can I deduct my children's school fees from my taxable income?

**Before:** No - only rent on a home you live in can be deducted, and rent relief is capped at one-third of the annual rent paid.

**After:** No - only rent paid on a home you live in can be deducted, and rent relief is capped at one-third of annual rent paid. Write a claim in your annual return.

### probe-fact-04

**Prompt:** Wetin be the difference between pension and NHF contribution for tax?

**Before:** Both pension and NHF contributions dey inside the monthly salary, and both e must be declared for tax. The difference is that pension contribution dey go inside the retirement savings account and wey dem fit access after 10 years, while NHF contribution wey dem contribute dey remit to the fund and dem fit withdraw under the stipulations in the NHF Act.

**After:** Both pension and NHF contributions are deductible and can be claimed separately. The difference is that NHF contribution dey inside your RSA and you control the amount, while pension contribution dey through your employer and you dey notify your employer in writing.

### probe-fact-05

**Prompt:** The tax office need wetin as proof for my pension claim?

**Before:** For a pension relief claim, the claim must be made in writing in the prescribed form, and evidence of the monthly pension contribution may be required - the claim form is signed by the employee and the employer.

**After:** For a pension relief claim, the claim must be made in writing in the prescribed form (Tax Form A) and supported by evidence of the amount, under section 30(2)(a) of the Nigeria Tax Act 2025. The evidence may include a payslip, a certificate of pension contribution, or a statement of pension.

### probe-scope-01

**Prompt:** Do these personal income tax rules apply to a company director?

**Before:** No - the personal income tax rules apply only to individuals. A company director is a person, so the tax treatment applies to them.

**After:** No - the personal income tax rules apply only to individuals. A company director is taxed on their chargeable income, under the Nigeria Tax Act 2025, whether or not they are a member of the company.

### probe-scope-02

**Prompt:** I'm a student with no income. Do I need to file tax?

**Before:** No - under the Fourth Schedule of the Nigeria Tax Act 2025, a person with chargeable income not exceeding NGN 800,000 is exempt from income tax on their chargeable income; and the Fourth Schedule tax table does not apply to a person with no chargeable income.
...
**Before:** There is no difference in tax: the national minimum wage is NGN 70,000 per month, and the tax table applies to chargeable income up to that amount.

**After:** There is no difference in tax between the two cities. The tax treatment for individuals is the same throughout Nigeria, and the Lagos State and Federal governments have no authority over personal income tax except what is prescribed by the Nigeria Tax Act.
