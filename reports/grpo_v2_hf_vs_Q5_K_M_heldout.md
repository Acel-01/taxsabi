...
- **before:** `data/captures/grpo_v2_probe_prompts_heldout.jsonl` (20 records)
- **after:** `data/captures/grpo_v2_Q5_K_M_heldout.jsonl` (20 records)
...
**Expected tax:** 6248600.00 | before: 5920600.00 | after: 5918600.00
...
**After:** Is that 70,000 per month or 700,000 per year?

### probe-calc-09

**Prompt:** My rent na 600k a year. How much relief I fit get?
**Expected tax:** 0.00 | before: 42000.00 | after: 3184800.00

**Before:** Gross income na NGN 1,200,000. Relief wey dey apply: rent (capped) NGN 120,000 - total relief na NGN 120,000. Chargeable income: NGN 1,080,000. Band breakdown: first NGN 800,000 at 0% = NGN 0; next NGN 280,000 at 15% = NGN 42,000. Total tax na NGN 42,000.

**After:** Gross income na NGN 18,000,000. Reliefs wey dey apply: rent (capped) NGN 120,000 - total relief na NGN 120,000. Chargeable income: NGN 17,880,000. Band breakdown: first NGN 800,000 at 0% = NGN 0; next NGN 2,200,000 at 15% = NGN 330,000; next NGN 9,000,000 at 18% = NGN 1,620,000; next NGN 5,880,000 at 21% = NGN 1,234,800. Total tax na NGN 3,184,800.
...
**Before:** In 2026, individuals are taxed on their chargeable income using the following bands: chargeable income up to NGN 800,000 is taxed at 0%; the next NGN 2,200,000 (NGN 800,000 to NGN 3,000,000) at 15%; the next NGN 9,000,000 (NGN 3,000,000 to NGN 12,000,000) at 18%; the next NGN 13,000,000 (NGN 12,000,000 to NGN 25,000,000) at 21%; the next NGN 25,000,000 (NGN 25,000,000 to NGN 50,000,000) at 23%; and anything above NGN 50,000,000 at 25%.

**After:** In 2026, individuals in Nigeria are taxed using the following bands: chargeable income up to NGN 800,000 is taxed at 0%; chargeable income between NGN 800,000 and NGN 2,000,000 is taxed at 15%; chargeable income between NGN 2,000,000 and NGN 5,000,000 is taxed at 18%; chargeable income between NGN 5,000,000 and NGN 10,000,000 is taxed at 21%; and chargeable income above NGN 10,000,000 is taxed at 23%. The first NGN 800,000 is therefore tax-free.

### probe-fact-02

**Prompt:** Is the rent deduction capped, and if so, at what amount?

**Before:** Yes - the rent relief is 20% of the annual rent paid, capped at NGN 500,000, whichever is lower. The actual rent must be accurately declared and evidence may be required.

**After:** Rent relief is 20% of annual rent paid, capped at NGN 200,000, whichever is lower. The actual rent must be accurately declared and evidence may be required.

### probe-fact-03

**Prompt:** Can I deduct my children's school fees from my taxable income?

**Before:** No - only rent paid on a home you live in can be deducted, and rent relief is capped at one-third of annual rent paid. Write a claim in your annual return for the deduction.

**After:** No - the deduction is only allowed for actual outlays on education and it must be claimed in writing with evidence.

### probe-fact-04

**Prompt:** Wetin be the difference between pension and NHF contribution for tax?

**Before:** The difference be simple: pension contribution wey you remit into your own RSA dem deduct from your salary, while NHF contribution wey you remit go the National Housing Fund for your own home. Both dem allow you to choose the amount, and you notify your employer in writing how much you intend to contribute.

**After:** The difference be simple: pension contribution wey you dem fit demy own salary, and NHF contribution wey your employer dem fit. Both na optional, but the one you dem contribute yourself dey escape the employer's tax on.

### probe-fact-05

**Prompt:** The tax office need wetin as proof for my pension claim?

**Before:** For a pension relief claim, the claim must be made in writing in the prescribed form (Tax Form A) and supported by evidence of the amount, under section 30 of the Nigeria Tax Act 2025. The evidence may include a payslip, a certificate of pension contribution, or a statement of pension.

**After:** For your pension claim, the tax authority demands documentary evidence of the pension contribution, under section 30(2)(a) of the Nigeria Tax Act 2025. Dem fit demand you provide proof of the contribution, and dem fit refuse the claim or reduce the amount am if the evidence no or is incomplete.

### probe-scope-01

**Prompt:** Do these personal income tax rules apply to a company director?

**Before:** No - the personal income tax rules apply only to individuals. A company director is an individual, so the director's personal income tax table applies to their chargeable income.

**After:** No - the personal income tax rules apply only to individuals. A company director is taxed on their chargeable income, but the tax is not deducted from their salary: the employer remits the director's personal tax to the relevant state tax authority through the annual return system, not through the old PAYE deducted payments.
...
**After:** Yes - even a student with no chargeable income still files an annual return, and the return is mandatory even if PAYE is due.

### probe-scope-03

**Prompt:** Abuja vs Lagos — any difference in tax?

**Before:** There is no difference in tax between the two cities. The tax treatment for individuals is the same throughout Nigeria, and the Lagos State and Federal governments have no authority over personal income tax.

**After:** There is no difference in tax between the two cities. The tax authority treats the two cities as part of the national territory and applies the same tax laws to both.
